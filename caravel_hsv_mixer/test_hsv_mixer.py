...
async def test_start(dut):
    ...
    await with_timeout(RisingEdge(dut.uut.mprj.wrapped_hsv_mixer_10.active), 500, 'us')
...
async def test_all(dut):
    ...
    await with_timeout(RisingEdge(dut.uut.mprj.wrapped_hsv_mixer_10.hsv_mixer0.reset), 500, 'us')
    await FallingEdge(dut.uut.mprj.wrapped_hsv_mixer_10.hsv_mixer0.reset)

    assert dut.uut.mprj.wrapped_hsv_mixer_10.hsv_mixer0.enc0.value == 0
    assert dut.uut.mprj.wrapped_hsv_mixer_10.hsv_mixer0.enc1.value == 0
    assert dut.uut.mprj.wrapped_hsv_mixer_10.hsv_mixer0.enc2.value == 0
